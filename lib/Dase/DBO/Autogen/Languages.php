...
class Dase_DBO_Autogen_Languages extends Dase_DBO 
{
	public function __construct($db,$assoc = false) 
	{
		parent::__construct($db,'languages', array('created_at','updated_at','name','family_id'));
		if ($assoc) {
    ...
    public function getFamily_id() { return $this->fields["family_id"]; }
}