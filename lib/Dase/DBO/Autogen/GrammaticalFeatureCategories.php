...
class Dase_DBO_Autogen_GrammaticalFeatureCategories extends Dase_DBO 
{
	public function __construct($db,$assoc = false) 
	{
		parent::__construct($db,'grammatical_feature_categories', array('created_at','updated_at','name'));
		if ($assoc) {
